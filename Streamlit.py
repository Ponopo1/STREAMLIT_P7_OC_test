...
if prediction_value>0.8 :
   st.markdown(''':green[CREDIT VALIDE]''')
else :
   st.markdown(''':red[CREDIT REFUSE]''')
streamviz.gauge(prediction_value,grLow=0.6,grMid=0.7)

# Ligne 2
if info_desc == True :
   st.markdown('### :blue[Information sur le client]')
...
if fact_influ == True :
   ...
   st.markdown('### :blue[Facteur d\'influence globaux]')
   ...
   st.pyplot(fig_shap_glob)

# Ligne 4
if Benchmark == True :
   st.markdown('### :blue[Comparaison avec autres clients via Boxplot]')
